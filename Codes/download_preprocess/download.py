...
class GEE_download:
    ...
    def get_gee_dict(self, data_name):
        ...
        month_end_date_dict = {
            'GRIDMET_Precip': datetime(2026, 1, 1),
            'GRIDMET_RET': datetime(2026, 1, 1),
            'GRIDMET_Tmax': datetime(2026, 1, 1),
            'GRIDMET_maxRH': datetime(2026, 1, 1),
            'GRIDMET_minRH': datetime(2026, 1, 1),
            'GRIDMET_windVel': datetime(2026, 1, 1),
            'GRIDMET_shortRad': datetime(2026, 1, 1),
            'GRIDMET_vpd': datetime(2026, 1, 1),
        ...
        year_end_date_dict = {
            'GRIDMET_Precip': datetime(2026, 1, 1),
            'GRIDMET_RET': datetime(2026, 12, 1),
            'GRIDMET_Tmax': datetime(2026, 12, 1),
            'GRIDMET_maxRH': datetime(2026, 1, 1),
            'GRIDMET_minRH': datetime(2026, 1, 1),
            'GRIDMET_windVel': datetime(2026, 1, 1),
            'GRIDMET_shortRad': datetime(2026, 1, 1),
            'GRIDMET_vpd': datetime(2026, 12, 1),
            'PRISM_Precip': datetime(2025, 1, 1),
            'PRISM_Tmax': datetime(2025, 1, 1),
            'PRISM_Tmean': datetime(2025, 1, 1),
