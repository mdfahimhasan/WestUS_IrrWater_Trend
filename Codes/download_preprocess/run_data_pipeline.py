...
def run_download_pipeline(ee_project, skip_gee_data_download, skip_gee_openET_download,
                          ...
                          grid_shape_for30m_lanid, huc8_shp=None, csv_out_dir=None,
    ...
    if not skip_globus_steamflow_download:
        ...
        mod_csv_out_dir  = str(csv_out_dir) if csv_out_dir else rel_path + "/Dayflow/processed"

        download_data_western_us_GLOBUS(years=year_list,
                                        output_dir=mod_download_dir,
                                        huc8_shp=str(huc8_shp),
                                        csv_out_dir=mod_csv_out_dir)
...
if __name__ == '__main__':
    ...
    run_download_pipeline(ee_project=download_pipeline_config['ee_project'],
                          ...
                          huc8_shp=download_pipeline_config['huc8_shp'],
                          csv_out_dir=download_pipeline_config['csv_out_dir'],
